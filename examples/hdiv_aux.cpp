...
int main(int argc, char *argv[])
{
   ...
   SparseMatrix Pi;
   {
      unique_ptr<SparseMatrix> Pi_ptr(Mult(R, I));
      Pi_ptr->Swap(Pi);
   }
   ...
   SparseMatrix A0;
   {
      unique_ptr<SparseMatrix> A0_ptr(RAP(P, A, P));
      A0_ptr->Swap(A0);
   }
   ...
   AuxiliaryPreconditioner aux(A_h1_inv, Pi, constraints.bdr_dofs);
   ...
   Vector X(A0.Height()), B(A0.Height());
