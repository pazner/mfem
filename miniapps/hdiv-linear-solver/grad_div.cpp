...
int main(int argc, char *argv[])
{
   ...
   HYPRE_BigInt n_rt_dofs = fes_rt.GlobalTrueVSize();
   if (Mpi::Root()) { cout << "Number of RT DOFs: " << n_rt_dofs << '\n'; }
   ...
   if (use_hybridization)
   {
      ...
      if (Mpi::Root()) { cout << "Solve: " << sw.RealTime() << endl; }
